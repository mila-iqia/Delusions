...
from utils import get_cpprb_env_dict, minigridobs2tensor, process_batch
...
# NOTE: we can use the following 2 lines to make sure that with the agent_ijx_mask is consistently extracted and used
